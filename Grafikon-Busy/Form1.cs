...
namespace Grafikon_Busy
{
    public partial class Form1 : Form
    {
        ...
        //How will the distances be rescaled
        const int PointMarkSize = 7;

        // Size of the points on chart
        ...
        float distanceSpread => (float)nudStopDist.Value;
        IReadOnlyList<CheckBox> CheckBoxesBack { get; }

        IReadOnlyList<CheckBox> CheckBoxesFront { get; }

        //The extra range between individual Y-labels (stop names) need on chart
